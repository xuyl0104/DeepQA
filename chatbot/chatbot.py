...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--corpus', choices=TextData.corpusChoices(), default=TextData.corpusChoices()[6], help='corpus on which extract the dataset.')
        ...
        datasetArgs.add_argument('--maxLength', type=int, default=40, help='maximum length of the sentence (for input and output), define number of maximum step of the RNN')
